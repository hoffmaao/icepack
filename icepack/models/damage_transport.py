...
class DamageTransport(object):
    def solve(
        self, dt, D0, u, A, ld=0.3, lh=.1, D_max=1.0, D_inflow=None, **kwargs
    ):
        ...
        Dnew.project(
            firedrake.conditional(D + f_term + h_term > D_max, D_max, D + f_term + h_term)
        )
        Dnew.project(
